import { AppGate } from "@cookielab.io/klovi-web/app";
import type { RPCClient } from "@cookielab.io/klovi-web/bootstrap";
import { setRPCClient } from "@cookielab.io/klovi-web/bootstrap";
...
setRPCClient(rpc as unknown as RPCClient);
